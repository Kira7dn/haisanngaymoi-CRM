...
Måc tiêu: Sau khi user hoàn t¥t OAuth, hiÃn thË dialog h°Ûng d«n c¥u hình webhook thç công và l°u thông tin platform-specific (App ID, OA ID, Client Key, etc.) vào database.

## <¯ User Flow

```
1. User clicks "Connect" on /crm/social/connections
2. OAuth flow completes ’ Redirect back vÛi success
3. ( NEW: Dialog popup vÛi 2 tabs:
   - Tab 1: "Platform Settings" - Form nh­p App ID, secrets, etc.
   - Tab 2: "Webhook Setup" - H°Ûng d«n c¥u hình webhook
4. User iÁn thông tin ’ Save
5. Database c­p nh­t vÛi platform config
    ...
    <div className="space-y-4">
      ...
      <div className="space-y-3">
        ...
        <ol className="space-y-3 list-decimal list-inside">
          ...
          <li>Navigate to <strong>Webhook Settings</strong> or <strong>Cài ·t Webhook</strong></li>
